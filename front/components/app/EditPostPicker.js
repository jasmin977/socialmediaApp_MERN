...
const ImgPicker = props => {
    ...
    const [pickedImage, setPickedImage] = useState(props.previousUpdate);
    ...
    const pickedImagesList = () => {
        ...
        return props.selectedPost.mediaRef.map((item, index) => {
            ...
            return (
                <View key={index} style={{
                    ...
                    <Image
                        resizeMode='cover'
                        style={styles.image}
                        source={{ uri: `${ENV.apiUrl}/media/photo/${item._id}` }}
                    />
    ...
    return (
        <View style={{ alignItems: 'center', width: '100%', }} >
            ...
            {props.selectedPost.mediaRef.length === 0 ? (
                <>
                    <View style={{
